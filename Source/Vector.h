...
#pragma region .   Swizzle Scalar
   ...
   template<class T, class U, int S, int X                     , GML_ENABLE_IF_NUMBER(U)> GML_CI Swizzle1<T, S, X         >& operator+=(Swizzle1<T, S, X         >& a, U b) noexcept { a = Vector1<T>(a) + Vector1<T>(b); return a; }
   template<class T, class U, int S, int X                     , GML_ENABLE_IF_NUMBER(U)> GML_CI Swizzle1<T, S, X         >& operator-=(Swizzle1<T, S, X         >& a, U b) noexcept { a = Vector1<T>(a) - Vector1<T>(b); return a; }
   template<class T, class U, int S, int X                     , GML_ENABLE_IF_NUMBER(U)> GML_CI Swizzle1<T, S, X         >& operator*=(Swizzle1<T, S, X         >& a, U b) noexcept { a = Vector1<T>(a) * Vector1<T>(b); return a; }
   template<class T, class U, int S, int X                     , GML_ENABLE_IF_NUMBER(U)> GML_CI Swizzle1<T, S, X         >& operator/=(Swizzle1<T, S, X         >& a, U b) noexcept { a = Vector1<T>(a) / Vector1<T>(b); return a; }
